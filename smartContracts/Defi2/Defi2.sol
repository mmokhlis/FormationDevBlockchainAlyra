    ...
    function postuler(uint idDemande) external illustrateurInscrit {
    ...
    function accepterOffre(uint idDemande, address addressCandidat ) external demandeurInscrit {
    ...
    function livraison(uint idDemande,string memory lienLivraison) external illustrateurInscrit {
